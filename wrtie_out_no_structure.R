...
true_p = 20
true_q = 20
x = generate_data_no_structure(525,true_p,true_q)
write.csv(x,"data_525_p=20_q=20_no_structure_identity.csv")
...
write.csv(output_reduced,"data_525_p=4_q=4_no_structure_identity.csv")
